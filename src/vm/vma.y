...
op_insn:
	...
	| OP_DIVU	{ $$ = vma_build_insn(INSN_DIVU); }
	| OP_DIVS	{ $$ = vma_build_insn(INSN_DIVS); }
	| OP_AND	{ $$ = vma_build_insn(INSN_AND); }
	| OP_OR		{ $$ = vma_build_insn(INSN_OR); }
	| OP_XOR	{ $$ = vma_build_insn(INSN_XOR); }
	| OP_NOT	{ $$ = vma_build_insn(INSN_NOT); }
	| OP_LSL	{ $$ = vma_build_insn(INSN_LSL); }
	| OP_LSR	{ $$ = vma_build_insn(INSN_LSR); }
	| OP_ASR	{ $$ = vma_build_insn(INSN_ASR); }
	| OP_CMP_LT	{ $$ = vma_build_insn(INSN_CMP_LT); }
	| OP_CMP_GT	{ $$ = vma_build_insn(INSN_CMP_GT); }
	| OP_CMP_LE	{ $$ = vma_build_insn(INSN_CMP_LE); }
	| OP_CMP_GE	{ $$ = vma_build_insn(INSN_CMP_GE); }
	| OP_CMP_B	{ $$ = vma_build_insn(INSN_CMP_B); }
	| OP_CMP_A	{ $$ = vma_build_insn(INSN_CMP_A); }
	| OP_CMP_BE	{ $$ = vma_build_insn(INSN_CMP_BE); }
	| OP_CMP_AE	{ $$ = vma_build_insn(INSN_CMP_AE); }
	| OP_CMP_EQ	{ $$ = vma_build_insn(INSN_CMP_EQ); }
	| OP_CMP_NE	{ $$ = vma_build_insn(INSN_CMP_NE); }
	| OP_LDC_0	{ $$ = vma_build_insn(INSN_LDC_0); }
	| OP_LDC_1	{ $$ = vma_build_insn(INSN_LDC_1); }
	| OP_LDC_2	{ $$ = vma_build_insn(INSN_LDC_2); }
	| OP_LDC_8_U expr { $$ = vma_build_insn(INSN_LDC_8_U); $$->u.expr = $2; }
	| OP_LDC_8_S expr { $$ = vma_build_insn(INSN_LDC_8_S); $$->u.expr = $2; }
	| OP_LDC_32 expr { $$ = vma_build_insn(INSN_LDC_32); $$->u.expr = $2; }
	| OP_LDM_8_U { $$ = vma_build_insn(INSN_LDM_8_U); }
	| OP_LDM_8_S { $$ = vma_build_insn(INSN_LDM_8_S); }
	| OP_LDM_16_U { $$ = vma_build_insn(INSN_LDM_16_U); }
	| OP_LDM_16_S { $$ = vma_build_insn(INSN_LDM_16_S); }
	...
	| OP_DUP	{ $$ = vma_build_insn(INSN_DUP); }
	| OP_SWAP	{ $$ = vma_build_insn(INSN_SWAP); }
	| OP_POP	{ $$ = vma_build_insn(INSN_POP); }
	| OP_BR_S IDENTIFIER { $$ = vma_build_insn(INSN_BR_S); vma_init_symref(&$$->u.symref, $2); }
	| OP_BR_L IDENTIFIER { $$ = vma_build_insn(INSN_BR_L); vma_init_symref(&$$->u.symref, $2); }
	| OP_BR_T IDENTIFIER { $$ = vma_build_insn(INSN_BR_T); vma_init_symref(&$$->u.symref, $2); }
	| OP_BR_F IDENTIFIER { $$ = vma_build_insn(INSN_BR_F); vma_init_symref(&$$->u.symref, $2); }
	| OP_CALL IDENTIFIER { $$ = vma_build_insn(INSN_CALL); vma_init_symref(&$$->u.symref, $2); }
	| OP_RET	{ $$ = vma_build_insn(INSN_RET); }
	| OP_ICALL	{ $$ = vma_build_insn(INSN_ICALL); }
	| OP_IJMP	{ $$ = vma_build_insn(INSN_IJMP); }
...
expr:
	...
	| expr '^' expr		{ $$ = vma_build_parent_expr(EXPR_XOR, $1, $3); }
	| expr '+' expr 	{ $$ = vma_build_parent_expr(EXPR_ADD, $1, $3); }
	| expr '-' expr 	{ $$ = vma_build_parent_expr(EXPR_SUB, $1, $3); }
	| expr '*' expr 	{ $$ = vma_build_parent_expr(EXPR_MUL, $1, $3); }
	| expr '/' expr 	{ $$ = vma_build_parent_expr(EXPR_DIV, $1, $3); }
	| '-' expr %prec NEG { $$ = vma_build_parent_expr(EXPR_NEG, $2, NULL); }
	| '~' expr %prec NOT { $$ = vma_build_parent_expr(EXPR_NOT, $2, NULL); }
	| '(' expr ')'		{ $$ = $2; }
;
